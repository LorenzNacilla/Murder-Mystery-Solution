...
--Results say that: Security footage shows that there were 2 witnesses. 
--The first witness lives at the last house on "Northwestern Dr". 
--The second witness, named Annabel, lives somewhere on "Franklin Ave".

---------------------------------------------------------------------------------------------------------------------------------------------------

--Getting details of witnesses - The following gives the first witness details:
...
--Witness 1 Statement: I heard a gunshot and then saw a man run out. He had a "Get Fit Now Gym" bag. 
...
--Membership IDS Starting with 48Z on that specific date:
--48Z7A
--48Z55

---------------------------------------------------------------------------------------------------------------------------------------------------

--Finding which one is the killer by joining all tables together using the membership_id and plate number:
...
--Killer name is Jeremy Bowers - id = 67318

---------------------------------------------------------------------------------------------------------------------------------------------------

--Finding the real villain by first plugging in the id of the killer in the interview table:

SELECT *
FROM interview
WHERE person_id = 67318

--Transcript is:  I was hired by a woman with a lot of money. I don't know her name but I know she's around 5'5" (65") or 5'7" (67"). 
--She has red hair and she drives a Tesla Model S. 
--I know that she attended the SQL Symphony Concert 3 times in December 2017.

--Then joining the facebook_event_checkin, person, and drivers_license tables together using the WHERE clause to filter based on Jeremy's transcript:
...
--Real villain is Miranda Priestly
